...
//   Compares the running @open-aippt/core version against the npm `latest`
...
//   Installs @open-aippt/core@latest with the detected package manager, then
//   runs `open-aippt sync:skills`.
...
function localOpenAipptCommand(cwd: string): CommandSpec {
