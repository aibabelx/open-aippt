---
title: open-aippt init
description: Scaffold a new workspace.
---

```npm
npx @open-aippt/cli init [directory]
```
...
and writes the matching preset into `open-aippt.config.ts` (see the
...
├── themes/                 # empty
├── open-aippt.config.ts    # framework config
