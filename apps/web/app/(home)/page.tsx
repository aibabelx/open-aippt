...
const jsonLd = [
  ...
  },
  {
    ...
    name: appName,
    url: siteUrl,
    logo: `${siteUrl}/open-aippt.png`,
    sameAs: [
      repoUrl,
      'https://www.npmjs.com/package/@open-aippt/core',
      'https://www.npmjs.com/package/@open-aippt/cli',
    ],
  },
  {
    '@context': 'https://schema.org',
  ...
  },
  {
    '@context': 'https://schema.org',
    '@type': 'HowTo',
    name: 'Author a slide deck with open-aippt',
    description:
      'Scaffold an open-aippt workspace, ask an AI agent to draft slides, then iterate visually in the browser.',
    totalTime: 'PT2M',
    supply: [
    ...
    step: [
      {
        ...
        text: 'Run npx @open-aippt/cli init my-deck to scaffold the slide workspace. Every future deck lives inside it.',
      },
      {
        '@type': 'HowToStep',
        position: 2,
