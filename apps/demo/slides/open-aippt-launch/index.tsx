...
import openAippt from './assets/open-aippt.png';
  ...
  >
    ...
    >
      ...
      >
        <img
          src={openAippt}
          alt="open-aippt square logo mark"
      ...
      >
        <Letters text="open-aippt" delay={780} step={42} duration={720} />
      </div>
    </div>
...
export const meta: SlideMeta = {
  title: 'open-aippt — Launch Motion',
