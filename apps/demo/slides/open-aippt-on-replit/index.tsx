import type { DesignSystem, Page, SlideMeta, SlideTransition } from '@open-aippt/core';
import createSlideSkill from './assets/create-slide-skill.webp';
import initCommand from './assets/init-command.webp';
import openaipptHome from './assets/openaippt-home.webp';
  ...
  <div style={fillLight}>
    ...
    >
      ...
      <div>
        ...
        >
          A hands-on guide to running open-aippt in the Replit Agent — install it, preview the
      ...
      >
        ...
        >
          <Step n="01" title="Ask the Agent to init">
            ...
            >
              <span style={{ color: p.accent }}>$</span> npx @open-aippt/cli init
            </code>
          </Step>
          <Step n="02" title="Open &amp; explore">
            open-aippt boots in the webview. Click any example slide to view it in the deck.
          </Step>
        </div>
        ...
        >
          <div>
            <Shot
              src={initCommand}
              ratio={1534 / 238}
              alt="Typing the open-aippt init command into the Replit Agent prompt"
            />
          ...
          <div>
            <Shot
              src={openaipptHome}
              ratio={3818 / 1780}
              alt="open-aippt home page running inside Replit with an example slide"
            />
            <Caption>open-aippt running in your Repl — examples ready to open.</Caption>
          </div>
        </div>
      </div>
    </div>
      ...
      >
        <div className="rf-fadeUp" style={{ animationDelay: '0.3s' }}>
          <Shot
            ...
            ratio={3815 / 1783}
            alt="A finished Replit features slide deck rendered in open-aippt inside Replit"
          />
      ...
      >
        <div className="rf-fadeUp" style={{ animationDelay: '0.18s' }}>
          ...
          >
            ...
            >
              open-aippt-init--ridemountainpig.replit.app
            </span>
          </div>
        </div>
        ...
        <div className="rf-fadeUp" style={{ animationDelay: '0.3s' }}>
          <Shot
            src={replitDeploy}
            ratio={2950 / 1158}
            alt="Replit Publishing panel showing the open-aippt deck deploying to a live replit.app URL"
          />
  ...
  >
    ...
    >
      ...
      <div>
        ...
        >
          Spin up a Repl, run{' '}
          <code style={{ fontFamily: font.mono }}>npx @open-aippt/cli init</code>, and let the Agent
          design your slides.
        </p>
      </div>
...
export const meta: SlideMeta = {
  title: 'Using open-aippt in Replit',
  theme: 'replit',
