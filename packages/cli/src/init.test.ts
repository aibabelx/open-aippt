...
describe('sanitizeDirName', () => {
  it('leaves safe names untouched', () => {
    ...
    expect(sanitizeDirName('Open_Aippt.workspace')).toBe('Open_Aippt.workspace');
  });
  ...
  it('replaces spaces with hyphens', () => {
    expect(sanitizeDirName('future of open-aippt and how can i help')).toBe(
      'future-of-open-aippt-and-how-can-i-help',
    );
  });
