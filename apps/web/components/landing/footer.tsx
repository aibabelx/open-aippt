      ...
      <div className="mx-auto max-w-[1360px] px-5 sm:px-8 lg:px-12 py-10 sm:py-14 grid grid-cols-12 gap-x-6 gap-y-10">
        <div className="col-span-12 lg:col-span-4 flex flex-col gap-4">
          <div className="flex items-center gap-3 font-[family-name:var(--font-mono)] text-[13px]">
            ...
            />
            <span className="tracking-[-0.01em]">open-aippt</span>
          </div>
        ...
        <FooterCol
          title="Packages"
          links={[
            ['@open-aippt/core', 'https://www.npmjs.com/package/@open-aippt/core'],
            ['@open-aippt/cli', 'https://www.npmjs.com/package/@open-aippt/cli'],
          ]}
        />
        <FooterCol
          title="Elsewhere"
          links={[
            ['GitHub', 'https://github.com/aibabelx/open-aippt'],
            ['npm', 'https://www.npmjs.com/package/@open-aippt/core'],
            ['Issues', 'https://github.com/aibabelx/open-aippt/issues'],
          ]}
        />
      </div>
